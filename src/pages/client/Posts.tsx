    ...
    <div className="flex flex-col gap-8">
      <div className="flex items-center gap-5 justify-between">
        <Link
          ...
          className="flex items-center justify-center bg-white w-1/2 h-[156px] rounded-md p-3 font-semibold text-2xl cursor-pointer shadow shadow-black/30"
        >
        ...
        <div className="flex items-center justify-center bg-white w-1/2 h-[156px] rounded-md p-3 font-semibold text-2xl cursor-pointer shadow shadow-black/30">
