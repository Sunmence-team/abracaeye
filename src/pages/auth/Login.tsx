...
const Login: React.FC = () => {
  ...
  return (
    <>
      <div className='relative z-1 h-screen w-full flex items-center justify-center overflow-hidden'>
        ...
        <div className='flex flex-col justify-center gap-5 items-center w-full max-w-md px-4 h-screen z-80'>
          <div className='text-center flex flex-col'>
            ...
            <p>Don't have an Account?
              <span className='font-semibold text-light-red'> <Link to={'/auth/register'} >Sign up</Link> </span>
            </p>
          </div>
